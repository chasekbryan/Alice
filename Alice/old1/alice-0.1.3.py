...
# ---
# Alice 0.1.3 — NOAA weather, web access toggle, package install, performance tweaks
# New in 0.1.3:
...
def main(argv: Optional[List[str]] = None) -> int:
    ap = argparse.ArgumentParser(description="Alice 0.1.3 — continuously-learning local AI (NOAA weather enabled)")
    ...
    print("Alice 0.1.3 is awake. Type /help for commands. (Ctrl+C to exit.)\n")
    while True:
        try:
