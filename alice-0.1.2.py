...
# ---
# Alice 0.1.2 — enhanced version with web access, package management, performance tweaks
...
try:
    ...
    requests = None
try:
    from bs4 import BeautifulSoup  # for HTML parsing in web content
except ImportError:
    BeautifulSoup = None
...
class Alice:
    ...
    def _cmd_web(self, raw: str) -> str:
        ...
        if action in ("on", "enable", "start"):
            ...
            return "- Web access: ENABLED (Alice can browse the internet)"
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    print("Alice 0.1.2 is awake. Type /help for commands. (Ctrl+C to exit.)\n")
    while True:
        try:
